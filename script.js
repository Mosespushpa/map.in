...
images:[{url:'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRXQ3EmmxFPmj3QUtXlHyWGA2P1DnBRMJQuF0PzPd16TQ&s=10', caption:'Red Fort'}, {url:'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSL5YACRj2pJEz3LK-YkgJsOph0pLRgZM_M5fK2ILZ3iw&s=10', caption:'India Gate'}]
 },
  { id: 'Puducherry', name:'Puducherry', capital:'Puducherry', area:'479 km²', population:'1.5 Million', language:'Tamil, Telugu, Malayalam, French', formed:1954, description:'Puducherry is a Union Territory with a unique French colonial heritage.', facts:['Former French colony','Known for beaches and Auroville','French architecture and culture'], historicalEvents:[{year:1954,event:'Puducherry merged with India'},{year:1962,event:'Officially became Union Territory'}],
    images:[
      {url:'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTxl7ZmoDN_x6m2mqgtFc9x6ft55MS-jC4-_KoFVHJdGQ&s=10', caption:'Puducherry Beach'},
       {url:'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSdSiLR8MDsE-WXl48SZfvPRRbDhAIlQb9ixjco5aVumg&s=10', caption:'Auroville'}
      ]},
  { id: 'Jammu_Kashmir', name:'Jammu & Kashmir', capital:'Srinagar (summer), Jammu (winter)', area:'55,530 km²', population:'12 Million',description:'Jammu and Kashmir is a union territory of India in the northern part of the Indian subcontinent, bounded by Ladakh, Himachal Pradesh, Punjab, and international borders with Pakistan. It has dual capitals: Srinagar in summer and Jammu in winte',
    facts:['Home to the Himalayas and Karakoram','Jammu and Kashmir — twin capitals','Srinagar — summer capital','Jammu — winter capital'], historicalEvents:[{year:1947,event:'Princely state merged with India'},{year:1954,event:'Jammu and Kashmir state formed'}],
    images:
    [{url:'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSuNMhGkBuWAmIDSH5eAh58JzHE1N-KQgDkT77s5pgFog&s=10', caption:'Dal Lake, Srinagar'}, 
      {url:'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRqvuLkrCjncdHsuHE_72qoTyTiQ5h1zBpdc1Tg9dEvSA&s=10', caption:'Jammu Fort'}
    ]},
  { id:'Ladakh', name:'Ladakh', capital:'Leh', area:'59,146 km²', population:'0.3 Million', description: 'Ladakh is a high-altitude union territory in northern India known as the "Land of High Passes". It spans the Himalayan and Karakoram mountain ranges, featuring stark desert landscapes, ancient Buddhist monasteries, and stunning alpine lakes like Pangong Tso.',
    images:
    [{url:'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcS7-_AamiFV0D7fz7gLIBsZXm0l7GQivYDsixVl08tOJg&s=10', caption:'Ladakh Landscape'}, 
